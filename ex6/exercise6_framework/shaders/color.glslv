...
uniform vec3 g_interestingPoint;
//=======================================================================
...
void main(void)
{
	...
	float dx = g_interestingPoint[0]-position[0];
	float dy = g_interestingPoint[1]-position[1];
	float dz = g_interestingPoint[2]-position[2];
	
	//	
	
	float dist = clamp((dx*dx + dy*dy + dz*dz)/400.0,0.0,1.0);
